...
#[command(
    name = "dovai",
    version,
    about = "Dovai — multi-provider AI coding assistant"
)]
pub struct Cli {
    #[arg(long)]
...
mod tests {
    ...
    fn parses_requested_flags() {
        ...
        assert_eq!(cli.model.as_deref(), Some("claude-3-5-haiku"));
